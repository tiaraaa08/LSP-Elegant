                ...
                <div class="modal-body">
                    <div class="row mb-3">
                        <div class="col-4">
                            ...
                            <input required type="date" name="waktu_transaksi" class="form-control border" id="exampleInputEmail1"
                                aria-describedby="emailHelp">
                        </div>
                        <div class="col-8">
                            <label for="exampleInputPassword1" class="form-label">Nama Pelanggan</label>
                            <input required type="text" name="nama_pelanggan" class="form-control border" placeholder="Masukkan Nama Pelanggan"
                    ...
                    <div class="row mb-3">
                        <div class="col-8">
                            ...
                            <select required class="form-select layanan" name="id_layanan" aria-label="Default select example">
                        ...
                        <div class="col-4">
                            ...
                            <div class="input-group">
                                <input required type="text" name="berat" class="form-control border berat" placeholder="Masukkan Berat"
                    ...
                    <div class="row mb-3">
                        <div class="col-5">
                            ...
                            <input required type="text" readonly class="form-control border totalRupiah" placeholder="Total yang Harus Dibayarkan">
                        </div>
                        <div class="col-7">
